...
function augment_image_and_mask_online(im0, gt0, common_path, no_of_iterations, object_id, save_image)
    ...
    for iters=1:no_of_iterations
        ...
        imwrite(gt1, [common_path '_' num2str(object_id) '_' num2str(iters) '_gt.png']);
        imwrite(seg1, [common_path '_' num2str(object_id) '_' num2str(iters) '_d1.png']);
        imwrite(seg2, [common_path '_' num2str(object_id) '_' num2str(iters) '_d2.png']);
        ...
        parfor a = 1:length(angles)
            ...
            imwrite(gt_rot_crop, [common_path '_' num2str(object_id) '_' num2str(iters) '_angle' int2str(angle) '_gt.png']);
            imwrite(seg1_rot_crop, [common_path '_' num2str(object_id) '_' num2str(iters) '_angle' int2str(angle) '_d1.png']);
            imwrite(seg2_rot_crop, [common_path '_' num2str(object_id) '_' num2str(iters) '_angle' int2str(angle) '_d2.png']);
            ...
            if flip
                ...
                imwrite(fliplr(gt_rot_crop), [common_path '_' num2str(object_id) '_' num2str(iters) '_angle' int2str(angle) '_flipped_gt.png']);
                imwrite(fliplr(seg1_rot_crop), [common_path '_' num2str(object_id) '_' num2str(iters) '_angle' int2str(angle) '_flipped_d1.png']);
                imwrite(fliplr(seg2_rot_crop), [common_path '_' num2str(object_id) '_' num2str(iters) '_angle' int2str(angle) '_flipped_d2.png']);
        ...
        if flip,
            ...
            imwrite(fliplr(gt1), [common_path '_' num2str(object_id) '_' num2str(iters) '_flipped_gt.png']);
            imwrite(fliplr(seg1), [common_path '_' num2str(object_id) '_' num2str(iters) '_flipped_d1.png']);
            imwrite(fliplr(seg2), [common_path '_' num2str(object_id) '_' num2str(iters) '_flipped_d2.png']);
        end
    end
end
